...
{
    [BurstCompile]
    public struct SpaceshipMurderTimeKillGhostComponentSerializer
    {
        static SpaceshipMurderTimeKillGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 14767913548786401661,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<SpaceshipMurderTime.Kill>(),
                ComponentSize = UnsafeUtility.SizeOf<SpaceshipMurderTime.Kill>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<SpaceshipMurderTime.Kill>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<SpaceshipMurderTime.Kill>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<SpaceshipMurderTime.Kill>(backupData, 0);
        ...
        private static void CalculateChangeMask(IntPtr snapshotData, IntPtr baselineData, IntPtr bits, int startOffset)
        {
            ...
            uint changeMask;
            changeMask = (snapshot.killerId != baseline.killerId) ? 1u : 0;
