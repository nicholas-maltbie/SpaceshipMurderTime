...
$ git clone git@github.com:nicholas-maltbie/SpaceshipMurderTime.git
# If you do not have ssh key setup, you can download via https
$ git clone https://github.com/nicholas-maltbie/SpaceshipMurderTime.git
```
...
`~/projects/SpaceshipMurderTime`. Then hit the `Open` 
